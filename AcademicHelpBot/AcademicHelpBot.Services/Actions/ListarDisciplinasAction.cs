...
{
  public class ListarDisciplinasAction : ActionBase<ListarDisciplinasAction>, IAction
  {
    private readonly IDisciplinaService _disciplinaService;

    public ListarDisciplinasAction(IDisciplinaService disciplinaService)
    {
    ...
    {
      return await _disciplinaService.ListarDisciplinasAsync(mensagem);
    }
  }
}
